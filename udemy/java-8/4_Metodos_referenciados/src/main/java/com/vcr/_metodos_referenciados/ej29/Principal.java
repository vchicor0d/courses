 ...
 */
package com.vcr._metodos_referenciados.ej29;

import com.vcr._metodos_referenciados.ej28.*;
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        El compilador infiere el método de instancia a través de su tipo
        (Método referenciado de instancia de un tipo arbitrario)
        */
